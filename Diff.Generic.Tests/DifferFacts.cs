...
namespace Diff.Generic.Tests
{
    public class DifferFacts
    {
        ...
        public class BuildModificationData
        {
            ...
            {
                var a = new ModificationData<string>("");
                var b = new ModificationData<string>("");
                ...
                DiffEngine<string>.BuildModificationData(a, b);
            ...
            {
                var a = new ModificationData<string>("");
                var b = new ModificationData<string>("cat", "hat", "pat", "matt");
            ...
            {
                var a = new ModificationData<string>("cat", "hat", "pat", "matt");
                var b = new ModificationData<string>("");
            ...
            {
                var a = new ModificationData<string>("cat", "hat", "pat", "matt");
                var b = new ModificationData<string>("door", "floor", "bore", "more");
                a.HashedPieces = new[] { 1, 2, 3, 4 };
            ...
            {
                var a = new ModificationData<string>("cat\nhat\npat\nmatt");
                var b = new ModificationData<string>("cat\nmatt\ntac");
                a.HashedPieces = new[] { 1, 2, 3, 4 };
            ...
            {
                var a = new ModificationData<string>("matt\ncat\nhat\n");
                var b = new ModificationData<string>("matt\ncat\ntat\nhat\n");
                a.HashedPieces = new[] { 1, 2, 3 };
        ...
        public class CalculateEditLength
        {
            ...
            public void Will_throw_if_arrays_are_null()
            {
                ...
                var ex = Record.Exception(() => DiffEngine<string>.CalculateEditLength(a, 0, 0, b, 0, 0)) as ArgumentNullException;
            ...
            {
                var res = DiffEngine<string>.CalculateEditLength(new int[0], 0, 0, new int[0], 0, 0);
            ...
            public void Will_return_length_of_a_if_b_is_empty()
            {
                ...
                var res = DiffEngine<string>.CalculateEditLength(a, 0, a.Length, b, 0, b.Length);
            ...
            public void Will_return_correct_length_when_start_and_ends_are_changed()
            {
                ...
                var res = DiffEngine<string>.CalculateEditLength(a, 1, a.Length - 1, b, 1, b.Length - 1);
